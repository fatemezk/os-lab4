...
80102322:	81 fb 28 56 11 80    	cmp    $0x80115628,%ebx
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 25 3c 00 00       	call   80106ab0 <switchkvm>
  seginit();
80102e8b:	e8 90 3b 00 00       	call   80106a20 <seginit>
  lapicinit();
...
80102eb7:	68 28 56 11 80       	push   $0x80115628
80102ebc:	e8 2f f5 ff ff       	call   801023f0 <kinit1>
  kvmalloc();      // kernel page table
80102ec1:	e8 ba 40 00 00       	call   80106f80 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 4b 3b 00 00       	call   80106a20 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 07 2e 00 00       	call   80105cf0 <uartinit>
  pinit();         // process table
...
80103604:	bb d4 2e 11 80       	mov    $0x80112ed4,%ebx
{
80103609:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010360c:	68 a0 2e 11 80       	push   $0x80112ea0
...
80103623:	81 fb d4 4d 11 80    	cmp    $0x80114dd4,%ebx
...
80103644:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103647:	68 a0 2e 11 80       	push   $0x80112ea0
  p->pid = nextpid++;
8010364c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103652:	e8 f9 0f 00 00       	call   80104650 <release>
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 34 59 10 80 	movl   $0x80105934,0x14(%eax)
  p->context = (struct context*)sp;
...
80103686:	e8 15 10 00 00       	call   801046a0 <memset>
...
801036a3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036a5:	68 a0 2e 11 80       	push   $0x80112ea0
801036aa:	e8 a1 0f 00 00       	call   80104650 <release>
}
...
801036d3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036d6:	68 a0 2e 11 80       	push   $0x80112ea0
801036db:	e8 70 0f 00 00       	call   80104650 <release>
...
8010372b:	68 a0 2e 11 80       	push   $0x80112ea0
80103730:	e8 1b 0d 00 00       	call   80104450 <initlock>
}
...
801037e4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801037e7:	e8 d4 0c 00 00       	call   801044c0 <pushcli>
  c = mycpu();
801037ec:	e8 4f ff ff ff       	call   80103740 <mycpu>
  p = c->proc;
801037f1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037f7:	e8 04 0d 00 00       	call   80104500 <popcli>
}
...
80103823:	e8 d8 36 00 00       	call   80106f00 <setupkvm>
...
80103841:	e8 9a 33 00 00       	call   80106be0 <inituvm>
...
80103856:	e8 45 0e 00 00       	call   801046a0 <memset>
...
801038af:	68 25 77 10 80       	push   $0x80107725
801038b4:	50                   	push   %eax
801038b5:	e8 c6 0f 00 00       	call   80104880 <safestrcpy>
  p->cwd = namei("/");
801038ba:	c7 04 24 2e 77 10 80 	movl   $0x8010772e,(%esp)
801038c1:	e8 1a e6 ff ff       	call   80101ee0 <namei>
801038c6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801038c9:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
801038d0:	e8 bb 0c 00 00       	call   80104590 <acquire>
  p->state = RUNNABLE;
801038d5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038dc:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
801038e3:	e8 68 0d 00 00       	call   80104650 <release>
}
...
801038f3:	68 0c 77 10 80       	push   $0x8010770c
...
80103905:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103908:	e8 b3 0b 00 00       	call   801044c0 <pushcli>
  c = mycpu();
8010390d:	e8 2e fe ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103912:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103918:	e8 e3 0b 00 00       	call   80104500 <popcli>
  if(n > 0){
...
8010392c:	e8 9f 31 00 00       	call   80106ad0 <switchuvm>
  return 0;
...
8010394a:	e8 d1 33 00 00       	call   80106d20 <allocuvm>
...
8010396a:	e8 e1 34 00 00       	call   80106e50 <deallocuvm>
...
80103986:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103989:	e8 32 0b 00 00       	call   801044c0 <pushcli>
  c = mycpu();
8010398e:	e8 ad fd ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103993:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103999:	e8 62 0b 00 00       	call   80104500 <popcli>
  if((np = allocproc()) == 0){
...
801039b8:	e8 13 36 00 00       	call   80106fd0 <copyuvm>
...
80103a31:	e8 4a 0e 00 00       	call   80104880 <safestrcpy>
  pid = np->pid;
80103a36:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a39:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
80103a40:	e8 4b 0b 00 00       	call   80104590 <acquire>
  np->state = RUNNABLE;
80103a45:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a4c:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
80103a53:	e8 f8 0b 00 00       	call   80104650 <release>
  return pid;
...
80103ac1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ac4:	bb d4 2e 11 80       	mov    $0x80112ed4,%ebx
    acquire(&ptable.lock);
80103ac9:	68 a0 2e 11 80       	push   $0x80112ea0
80103ace:	e8 bd 0a 00 00       	call   80104590 <acquire>
...
80103af0:	e8 db 2f 00 00       	call   80106ad0 <switchuvm>
...
80103afb:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b02:	e8 d4 0d 00 00       	call   801048db <swtch>
      switchkvm();
80103b07:	e8 a4 2f 00 00       	call   80106ab0 <switchkvm>
      c->proc = 0;
...
80103b1c:	81 fb d4 4d 11 80    	cmp    $0x80114dd4,%ebx
80103b22:	72 bc                	jb     80103ae0 <scheduler+0x40>
    release(&ptable.lock);
80103b24:	83 ec 0c             	sub    $0xc,%esp
80103b27:	68 a0 2e 11 80       	push   $0x80112ea0
80103b2c:	e8 1f 0b 00 00       	call   80104650 <release>
    sti();
...
80103b44:	53                   	push   %ebx
  pushcli();
80103b45:	e8 76 09 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103b4a:	e8 f1 fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103b4f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b55:	e8 a6 09 00 00       	call   80104500 <popcli>
  if(!holding(&ptable.lock))
80103b5a:	83 ec 0c             	sub    $0xc,%esp
80103b5d:	68 a0 2e 11 80       	push   $0x80112ea0
80103b62:	e8 f9 09 00 00       	call   80104560 <holding>
...
80103ba3:	e8 33 0d 00 00       	call   801048db <swtch>
  mycpu()->intena = intena;
...
80103c06:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c09:	e8 b2 08 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103c0e:	e8 2d fb ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103c13:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c19:	e8 e2 08 00 00       	call   80104500 <popcli>
  if(curproc == initproc)
...
80103c64:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103c6b:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
80103c72:	e8 19 09 00 00       	call   80104590 <acquire>
...
80103cd7:	75 e7                	jne    80103cc0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cd9:	b8 d4 2e 11 80       	mov    $0x80112ed4,%eax
...
80103d0d:	68 7d 77 10 80       	push   $0x8010777d
80103d12:	e8 79 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d17:	83 ec 0c             	sub    $0xc,%esp
80103d1a:	68 70 77 10 80       	push   $0x80107770
...
80103d37:	68 a0 2e 11 80       	push   $0x80112ea0
80103d3c:	e8 4f 08 00 00       	call   80104590 <acquire>
  pushcli();
80103d41:	e8 7a 07 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103d46:	e8 f5 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d51:	e8 aa 07 00 00       	call   80104500 <popcli>
  myproc()->state = RUNNABLE;
80103d56:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103d5d:	e8 de fd ff ff       	call   80103b40 <sched>
  release(&ptable.lock);
80103d62:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
80103d69:	e8 e2 08 00 00       	call   80104650 <release>
}
...
80103d8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103d8f:	e8 2c 07 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103d94:	e8 a7 f9 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103d99:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d9f:	e8 5c 07 00 00       	call   80104500 <popcli>
  if(p == 0)
...
80103db0:	81 fe a0 2e 11 80    	cmp    $0x80112ea0,%esi
80103db6:	74 50                	je     80103e08 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103db8:	83 ec 0c             	sub    $0xc,%esp
80103dbb:	68 a0 2e 11 80       	push   $0x80112ea0
80103dc0:	e8 cb 07 00 00       	call   80104590 <acquire>
    release(lk);
...
80103ddc:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103de3:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
80103dea:	e8 61 08 00 00       	call   80104650 <release>
    acquire(lk);
...
80103dfb:	5d                   	pop    %ebp
    acquire(lk);
80103dfc:	e9 8f 07 00 00       	jmp    80104590 <acquire>
...
80103e29:	68 8f 77 10 80       	push   $0x8010778f
80103e2e:	e8 5d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e33:	83 ec 0c             	sub    $0xc,%esp
80103e36:	68 89 77 10 80       	push   $0x80107789
...
80103e44:	53                   	push   %ebx
  pushcli();
80103e45:	e8 76 06 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103e4a:	e8 f1 f8 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103e4f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e55:	e8 a6 06 00 00       	call   80104500 <popcli>
  acquire(&ptable.lock);
80103e5a:	83 ec 0c             	sub    $0xc,%esp
80103e5d:	68 a0 2e 11 80       	push   $0x80112ea0
80103e62:	e8 29 07 00 00       	call   80104590 <acquire>
80103e67:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103e6a:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e6c:	bb d4 2e 11 80       	mov    $0x80112ed4,%ebx
...
80103eac:	68 a0 2e 11 80       	push   $0x80112ea0
...
80103ed2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ed9:	e8 a2 2f 00 00       	call   80106e80 <freevm>
        release(&ptable.lock);
80103ede:	c7 04 24 a0 2e 11 80 	movl   $0x80112ea0,(%esp)
        p->pid = 0;
...
80103efe:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f05:	e8 46 07 00 00       	call   80104650 <release>
        return pid;
...
80103f19:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f1e:	68 a0 2e 11 80       	push   $0x80112ea0
80103f23:	e8 28 07 00 00       	call   80104650 <release>
      return -1;
...
80103f37:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103f3a:	68 a0 2e 11 80       	push   $0x80112ea0
80103f3f:	e8 4c 06 00 00       	call   80104590 <acquire>
80103f44:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f47:	b8 d4 2e 11 80       	mov    $0x80112ed4,%eax
...
80103f74:	72 e4                	jb     80103f5a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103f76:	c7 45 08 a0 2e 11 80 	movl   $0x80112ea0,0x8(%ebp)
}
80103f7d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103f80:	c9                   	leave  
  release(&ptable.lock);
80103f81:	e9 ca 06 00 00       	jmp    80104650 <release>
...
80103f97:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
80103f9a:	68 a0 2e 11 80       	push   $0x80112ea0
80103f9f:	e8 ec 05 00 00       	call   80104590 <acquire>
80103fa4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fa7:	b8 d4 2e 11 80       	mov    $0x80112ed4,%eax
...
80103fd6:	68 a0 2e 11 80       	push   $0x80112ea0
...
80103ff3:	68 a0 2e 11 80       	push   $0x80112ea0
80103ff8:	e8 53 06 00 00       	call   80104650 <release>
  return -1;
...
80104016:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104019:	bb d4 2e 11 80       	mov    $0x80112ed4,%ebx
{
...
8010402b:	68 57 7b 10 80       	push   $0x80107b57
...
8010404e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104051:	ba a0 77 10 80       	mov    $0x801077a0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104056:	77 11                	ja     80104069 <procdump+0x59>
80104058:	8b 14 85 00 78 10 80 	mov    -0x7fef8800(,%eax,4),%edx
      state = "???";
8010405f:	b8 a0 77 10 80       	mov    $0x801077a0,%eax
...
80104071:	68 a4 77 10 80       	push   $0x801077a4
...
80104098:	e8 d3 03 00 00       	call   80104470 <getcallerpcs>
...
801040ad:	68 e1 71 10 80       	push   $0x801071e1
...
801040d3:	dd 45 08             	fldl   0x8(%ebp)
    double root=s/3;
    int i;
    if(s<=0)return 0;
801040d6:	d9 ee                	fldz   
801040d8:	db e9                	fucomi %st(1),%st
801040da:	73 2c                	jae    80104108 <sq+0x38>
801040dc:	dd d8                	fstp   %st(0)
    double root=s/3;
801040de:	d9 c0                	fld    %st(0)
801040e0:	b8 20 00 00 00       	mov    $0x20,%eax
801040e5:	d8 35 18 78 10 80    	fdivs  0x80107818
801040eb:	90                   	nop
801040ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    for(i=0;i<32;i++){
        root=(root+s / root)/2;}
801040f0:	d9 c1                	fld    %st(1)
    for(i=0;i<32;i++){
801040f2:	83 e8 01             	sub    $0x1,%eax
        root=(root+s / root)/2;}
801040f5:	d8 f1                	fdiv   %st(1),%st
801040f7:	de c1                	faddp  %st,%st(1)
801040f9:	d8 0d 1c 78 10 80    	fmuls  0x8010781c
    for(i=0;i<32;i++){
801040ff:	75 ef                	jne    801040f0 <sq+0x20>
80104101:	dd d9                	fstp   %st(1)
80104103:	eb 05                	jmp    8010410a <sq+0x3a>
80104105:	8d 76 00             	lea    0x0(%esi),%esi
80104108:	dd d9                	fstp   %st(1)
        return root;
}
8010410a:	5d                   	pop    %ebp
8010410b:	c3                   	ret    
...
80104110 <find_largest_prime_factor>:
...
80104118:	8b 4d 08             	mov    0x8(%ebp),%ecx
   int i, max = -1;
   while(n % 2 == 0) {
8010411b:	f6 c1 01             	test   $0x1,%cl
8010411e:	0f 85 a0 00 00 00    	jne    801041c4 <find_largest_prime_factor+0xb4>
80104124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      max = 2;
      n = n/2; 
80104128:	89 c8                	mov    %ecx,%eax
8010412a:	c1 e8 1f             	shr    $0x1f,%eax
8010412d:	01 c1                	add    %eax,%ecx
8010412f:	d1 f9                	sar    %ecx
   while(n % 2 == 0) {
80104131:	f6 c1 01             	test   $0x1,%cl
80104134:	74 f2                	je     80104128 <find_largest_prime_factor+0x18>
      max = 2;
80104136:	be 02 00 00 00       	mov    $0x2,%esi
8010413b:	89 4d f4             	mov    %ecx,-0xc(%ebp)
   }
   for(i = 3; i <= sq(n); i=i+2){ 
8010413e:	bb 03 00 00 00       	mov    $0x3,%ebx
80104143:	db 45 f4             	fildl  -0xc(%ebp)
80104146:	8d 76 00             	lea    0x0(%esi),%esi
80104149:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
80104150:	89 5d f4             	mov    %ebx,-0xc(%ebp)
80104153:	db 45 f4             	fildl  -0xc(%ebp)
    if(s<=0)return 0;
80104156:	d9 ee                	fldz   
80104158:	db ea                	fucomi %st(2),%st
8010415a:	73 25                	jae    80104181 <find_largest_prime_factor+0x71>
8010415c:	dd d8                	fstp   %st(0)
    double root=s/3;
8010415e:	d9 c1                	fld    %st(1)
80104160:	b8 20 00 00 00       	mov    $0x20,%eax
80104165:	d8 35 18 78 10 80    	fdivs  0x80107818
8010416b:	90                   	nop
8010416c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        root=(root+s / root)/2;}
80104170:	d9 c2                	fld    %st(2)
    for(i=0;i<32;i++){
80104172:	83 e8 01             	sub    $0x1,%eax
        root=(root+s / root)/2;}
80104175:	d8 f1                	fdiv   %st(1),%st
80104177:	de c1                	faddp  %st,%st(1)
80104179:	d8 0d 1c 78 10 80    	fmuls  0x8010781c
    for(i=0;i<32;i++){
8010417f:	75 ef                	jne    80104170 <find_largest_prime_factor+0x60>
   for(i = 3; i <= sq(n); i=i+2){ 
80104181:	df e9                	fucomip %st(1),%st
80104183:	dd d8                	fstp   %st(0)
80104185:	72 2c                	jb     801041b3 <find_largest_prime_factor+0xa3>
   
      while(n % i == 0) {
80104187:	89 c8                	mov    %ecx,%eax
80104189:	99                   	cltd   
8010418a:	f7 fb                	idiv   %ebx
8010418c:	85 d2                	test   %edx,%edx
8010418e:	75 1e                	jne    801041ae <find_largest_prime_factor+0x9e>
80104190:	dd d8                	fstp   %st(0)
80104192:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
         max = i;
         n = n/i;
80104198:	89 c8                	mov    %ecx,%eax
8010419a:	99                   	cltd   
8010419b:	f7 fb                	idiv   %ebx
      while(n % i == 0) {
8010419d:	99                   	cltd   
         n = n/i;
8010419e:	89 c1                	mov    %eax,%ecx
      while(n % i == 0) {
801041a0:	f7 fb                	idiv   %ebx
801041a2:	85 d2                	test   %edx,%edx
801041a4:	74 f2                	je     80104198 <find_largest_prime_factor+0x88>
801041a6:	89 4d f4             	mov    %ecx,-0xc(%ebp)
         max = i;
801041a9:	89 de                	mov    %ebx,%esi
801041ab:	db 45 f4             	fildl  -0xc(%ebp)
   for(i = 3; i <= sq(n); i=i+2){ 
801041ae:	83 c3 02             	add    $0x2,%ebx
801041b1:	eb 9d                	jmp    80104150 <find_largest_prime_factor+0x40>
801041b3:	dd d8                	fstp   %st(0)
      }
   }
   if(n > 2) {
801041b5:	83 f9 03             	cmp    $0x3,%ecx
801041b8:	0f 4d f1             	cmovge %ecx,%esi
      max = n;
   }
   return max;
}
801041bb:	83 c4 08             	add    $0x8,%esp
...
801041c3:	c3                   	ret    
   int i, max = -1;
801041c4:	be ff ff ff ff       	mov    $0xffffffff,%esi
801041c9:	e9 6d ff ff ff       	jmp    8010413b <find_largest_prime_factor+0x2b>
...
801041dc:	c1 e3 06             	shl    $0x6,%ebx
801041df:	8d bb 2c 2d 11 80    	lea    -0x7feed2d4(%ebx),%edi
801041e5:	57                   	push   %edi
801041e6:	e8 a5 03 00 00       	call   80104590 <acquire>

  if (chop_stick[i].locked == 0) {
801041eb:	8b b3 24 2d 11 80    	mov    -0x7feed2dc(%ebx),%esi
801041f1:	83 c4 10             	add    $0x10,%esp
801041f4:	85 f6                	test   %esi,%esi
801041f6:	75 38                	jne    80104230 <sem_init+0x60>
  } else {
...
801041fe:	c7 83 24 2d 11 80 01 	movl   $0x1,-0x7feed2dc(%ebx)
80104205:	00 00 00 
  release(&chop_stick[i].lock);
80104208:	57                   	push   %edi
    chop_stick[i].owner = -1;
80104209:	c7 83 28 2d 11 80 ff 	movl   $0xffffffff,-0x7feed2d8(%ebx)
80104210:	ff ff ff 
    chop_stick[i].value = v;
80104213:	89 83 20 2d 11 80    	mov    %eax,-0x7feed2e0(%ebx)
  release(&chop_stick[i].lock);
80104219:	e8 32 04 00 00       	call   80104650 <release>
...
8010425c:	c1 e7 06             	shl    $0x6,%edi

  acquire(&chop_stick[i].lock);
8010425f:	8d 9f 2c 2d 11 80    	lea    -0x7feed2d4(%edi),%ebx

  if (chop_stick[i].value >= 1) {
80104265:	8d b7 20 2d 11 80    	lea    -0x7feed2e0(%edi),%esi
  acquire(&chop_stick[i].lock);
8010426b:	53                   	push   %ebx
8010426c:	e8 1f 03 00 00       	call   80104590 <acquire>
  if (chop_stick[i].value >= 1) {
80104271:	8b 97 20 2d 11 80    	mov    -0x7feed2e0(%edi),%edx
80104277:	83 c4 10             	add    $0x10,%esp
8010427a:	85 d2                	test   %edx,%edx
8010427c:	7e 22                	jle    801042a0 <sem_acquire+0x50>
     chop_stick[i].value = chop_stick[i].value - 1;
     chop_stick[i].owner = i;
8010427e:	8b 45 08             	mov    0x8(%ebp),%eax
     chop_stick[i].value = chop_stick[i].value - 1;
80104281:	83 ea 01             	sub    $0x1,%edx
80104284:	89 97 20 2d 11 80    	mov    %edx,-0x7feed2e0(%edi)
     chop_stick[i].owner = i;
8010428a:	89 46 08             	mov    %eax,0x8(%esi)
...
80104291:	e8 ba 03 00 00       	call   80104650 <release>

  return 0;
}
80104296:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104299:	31 c0                	xor    %eax,%eax
8010429b:	5b                   	pop    %ebx
8010429c:	5e                   	pop    %esi
8010429d:	5f                   	pop    %edi
8010429e:	5d                   	pop    %ebp
...
801042aa:	8b 97 20 2d 11 80    	mov    -0x7feed2e0(%edi),%edx
801042b0:	83 c4 10             	add    $0x10,%esp
801042b3:	85 d2                	test   %edx,%edx
801042b5:	7e e9                	jle    801042a0 <sem_acquire+0x50>
    chop_stick[i].owner = i;
801042b7:	8b 45 08             	mov    0x8(%ebp),%eax
    chop_stick[i].value = chop_stick[i].value - 1;
801042ba:	83 ea 01             	sub    $0x1,%edx
801042bd:	89 97 20 2d 11 80    	mov    %edx,-0x7feed2e0(%edi)
    chop_stick[i].owner = i;
801042c3:	89 87 28 2d 11 80    	mov    %eax,-0x7feed2d8(%edi)
801042c9:	eb c2                	jmp    8010428d <sem_acquire+0x3d>
801042cb:	90                   	nop
801042cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801042d0 <sem_release>:
...
801042db:	c1 e3 06             	shl    $0x6,%ebx
801042de:	8d b3 2c 2d 11 80    	lea    -0x7feed2d4(%ebx),%esi
801042e4:	56                   	push   %esi
801042e5:	e8 a6 02 00 00       	call   80104590 <acquire>
  chop_stick[i].value = chop_stick[i].value + 1;
801042ea:	8d 83 20 2d 11 80    	lea    -0x7feed2e0(%ebx),%eax
801042f0:	83 83 20 2d 11 80 01 	addl   $0x1,-0x7feed2e0(%ebx)
  chop_stick[i].owner = -1;
801042f7:	c7 83 28 2d 11 80 ff 	movl   $0xffffffff,-0x7feed2d8(%ebx)
801042fe:	ff ff ff 
  wakeup(&chop_stick[i]); 
...
8010430c:	e8 3f 03 00 00       	call   80104650 <release>
...
8010432a:	68 20 78 10 80       	push   $0x80107820
...
80104385:	e8 f6 f9 ff ff       	call   80103d80 <sleep>
  while (lk->locked) {
...
80104393:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104399:	e8 42 f4 ff ff       	call   801037e0 <myproc>
...
801043e4:	e8 47 fb ff ff       	call   80103f30 <wakeup>
  release(&lk->lk);
...
80104423:	e8 b8 f3 ff ff       	call   801037e0 <myproc>
...
801044c9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801044ca:	e8 71 f2 ff ff       	call   80103740 <mycpu>
...
801044df:	e8 5c f2 ff ff       	call   80103740 <mycpu>
801044e4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801044ea:	e8 51 f2 ff ff       	call   80103740 <mycpu>
...
8010452c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104530:	e8 0b f2 ff ff       	call   80103740 <mycpu>
...
80104545:	68 2b 78 10 80       	push   $0x8010782b
8010454a:	e8 41 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010454f:	83 ec 0c             	sub    $0xc,%esp
80104552:	68 42 78 10 80       	push   $0x80107842
...
80104578:	e8 c3 f1 ff ff       	call   80103740 <mycpu>
...
801045d4:	e8 67 f1 ff ff       	call   80103740 <mycpu>
...
80104637:	68 49 78 10 80       	push   $0x80107849
...
8010468c:	68 51 78 10 80       	push   $0x80107851
...
801049a5:	e8 36 ee ff ff       	call   801037e0 <myproc>
...
801049b3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049b6:	e8 25 ee ff ff       	call   801037e0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801049f8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049fb:	e8 e0 ed ff ff       	call   801037e0 <myproc>
...
80104a94:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a97:	e8 44 ed ff ff       	call   801037e0 <myproc>
...
80104aa7:	83 fa 18             	cmp    $0x18,%edx
80104aaa:	77 1c                	ja     80104ac8 <syscall+0x38>
80104aac:	8b 14 85 80 78 10 80 	mov    -0x7fef8780(,%eax,4),%edx
...
80104ad0:	68 59 78 10 80       	push   $0x80107859
...
80104c24:	68 04 79 10 80       	push   $0x80107904
...
80104c3c:	68 03 79 10 80       	push   $0x80107903
...
80104c55:	68 f7 78 10 80       	push   $0x801078f7
...
80104c6a:	68 06 79 10 80       	push   $0x80107906
80104c6f:	e8 1c b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c74:	83 ec 0c             	sub    $0xc,%esp
80104c77:	68 e8 78 10 80       	push   $0x801078e8
...
80104cb4:	e8 27 eb ff ff       	call   801037e0 <myproc>
...
80104cf9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104cfb:	e8 e0 ea ff ff       	call   801037e0 <myproc>
...
80104e43:	78 2b                	js     80104e70 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e45:	e8 96 e9 ff ff       	call   801037e0 <myproc>
...
80105069:	58                   	pop    %eax
8010506a:	5a                   	pop    %edx
8010506b:	68 04 79 10 80       	push   $0x80107904
...
80105084:	68 03 79 10 80       	push   $0x80107903
...
8010527f:	0f 84 a6 00 00 00    	je     8010532b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105285:	e8 56 e5 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105657:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010565a:	e8 81 e1 ff ff       	call   801037e0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105691:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105698:	e8 43 e1 ff ff       	call   801037e0 <myproc>
...
801056d3:	5d                   	pop    %ebp
  return fork();
801056d4:	e9 a7 e2 ff ff       	jmp    80103980 <fork>
...
801056e3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056e6:	e8 15 e5 ff ff       	call   80103c00 <exit>
...
801056f3:	5d                   	pop    %ebp
  return wait();
801056f4:	e9 47 e7 ff ff       	jmp    80103e40 <wait>
...
8010571e:	e8 6d e8 ff ff       	call   80103f90 <kill>
...
80105743:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105746:	e8 95 e0 ff ff       	call   801037e0 <myproc>
...
80105776:	e8 85 e1 ff ff       	call   80103900 <growproc>
...
801057c0:	68 e0 4d 11 80       	push   $0x80114de0
...
801057cd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801057d0:	8b 1d 20 56 11 80    	mov    0x80115620,%ebx
  while(ticks - ticks0 < n){
...
801057e3:	68 e0 4d 11 80       	push   $0x80114de0
801057e8:	68 20 56 11 80       	push   $0x80115620
801057ed:	e8 8e e5 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
801057f2:	a1 20 56 11 80       	mov    0x80115620,%eax
...
80105854:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105857:	68 e0 4d 11 80       	push   $0x80114de0
8010585c:	e8 2f ed ff ff       	call   80104590 <acquire>
  xticks = ticks;
80105861:	8b 1d 20 56 11 80    	mov    0x80115620,%ebx
  release(&tickslock);
80105867:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
...
80105880 <sys_find_largest_prime_factor>:
...
8010588f:	83 ec 08             	sub    $0x8,%esp
  int num = myproc()->tf->ebx; //register after eax
80105892:	8b 58 10             	mov    0x10(%eax),%ebx
  cprintf("sys_find_largest_prime_factor()called for %d\n" ,num);
80105895:	53                   	push   %ebx
80105896:	68 4c 79 10 80       	push   $0x8010794c
8010589b:	e8 c0 ad ff ff       	call   80100660 <cprintf>
  return find_largest_prime_factor(num);
801058a0:	89 1c 24             	mov    %ebx,(%esp)
801058a3:	e8 68 e8 ff ff       	call   80104110 <find_largest_prime_factor>
}
...
801058bc:	e8 df f0 ff ff       	call   801049a0 <argint>
  argint(1,&j);
801058c1:	58                   	pop    %eax
...
801058c9:	e8 d2 f0 ff ff       	call   801049a0 <argint>
  return sem_init(i,j);
801058ce:	59                   	pop    %ecx
801058cf:	58                   	pop    %eax
801058d0:	ff 75 f4             	pushl  -0xc(%ebp)
801058d3:	ff 75 f0             	pushl  -0x10(%ebp)
801058d6:	e8 f5 e8 ff ff       	call   801041d0 <sem_init>
}
801058db:	c9                   	leave  
801058dc:	c3                   	ret    
801058dd:	8d 76 00             	lea    0x0(%esi),%esi

801058e0 <sys_sem_acquire>:
...
801058f5:	e8 56 e9 ff ff       	call   80104250 <sem_acquire>
}
801058fa:	c9                   	leave  
801058fb:	c3                   	ret    
801058fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105900 <sys_sem_release>:
...
80105915:	e8 b6 e9 ff ff       	call   801042d0 <sem_release>
8010591a:	c9                   	leave  
8010591b:	c3                   	ret    
...
8010591d:	06                   	push   %es
  pushl %fs
8010591e:	0f a0                	push   %fs
  pushl %gs
80105920:	0f a8                	push   %gs
  pushal
80105922:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105923:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105927:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105929:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010592b:	54                   	push   %esp
  call trap
8010592c:	e8 bf 00 00 00       	call   801059f0 <trap>
  addl $4, %esp
80105931:	83 c4 04             	add    $0x4,%esp
...
80105934:	61                   	popa   
  popl %gs
80105935:	0f a9                	pop    %gs
  popl %fs
80105937:	0f a1                	pop    %fs
  popl %es
80105939:	07                   	pop    %es
  popl %ds
8010593a:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010593b:	83 c4 08             	add    $0x8,%esp
  iret
8010593e:	cf                   	iret   
8010593f:	90                   	nop
...
80105957:	c7 04 c5 22 4e 11 80 	movl   $0x8e000008,-0x7feeb1de(,%eax,8)
8010595e:	08 00 00 8e 
80105962:	66 89 14 c5 20 4e 11 	mov    %dx,-0x7feeb1e0(,%eax,8)
80105969:	80 
8010596a:	c1 ea 10             	shr    $0x10,%edx
8010596d:	66 89 14 c5 26 4e 11 	mov    %dx,-0x7feeb1da(,%eax,8)
80105974:	80 
  for(i = 0; i < 256; i++)
...
80105984:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105987:	c7 05 22 50 11 80 08 	movl   $0xef000008,0x80115022
8010598e:	00 00 ef 
  initlock(&tickslock, "time");
80105991:	68 7a 79 10 80       	push   $0x8010797a
80105996:	68 e0 4d 11 80       	push   $0x80114de0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010599b:	66 a3 20 50 11 80    	mov    %ax,0x80115020
801059a1:	c1 e8 10             	shr    $0x10,%eax
801059a4:	66 a3 26 50 11 80    	mov    %ax,0x80115026
  initlock(&tickslock, "time");
...
80105a10:	ff 24 85 20 7a 10 80 	jmp    *-0x7fef85e0(,%eax,4)
...
80105a20:	e8 bb dd ff ff       	call   801037e0 <myproc>
...
80105a51:	e8 8a dd ff ff       	call   801037e0 <myproc>
80105a56:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105a59:	e8 82 dd ff ff       	call   801037e0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105a75:	68 dc 79 10 80       	push   $0x801079dc
...
80105a8e:	e8 4d dd ff ff       	call   801037e0 <myproc>
80105a93:	85 c0                	test   %eax,%eax
80105a95:	74 1d                	je     80105ab4 <trap+0xc4>
80105a97:	e8 44 dd ff ff       	call   801037e0 <myproc>
...
80105abd:	e8 1e dd ff ff       	call   801037e0 <myproc>
...
80105ad1:	e8 0a dd ff ff       	call   801037e0 <myproc>
...
80105b02:	0f 85 e8 00 00 00    	jne    80105bf0 <trap+0x200>
    myproc()->tf = tf;
80105b08:	e8 d3 dc ff ff       	call   801037e0 <myproc>
80105b0d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b10:	e8 7b ef ff ff       	call   80104a90 <syscall>
    if(myproc()->killed)
80105b15:	e8 c6 dc ff ff       	call   801037e0 <myproc>
...
80105baf:	e8 0c dc ff ff       	call   801037c0 <cpuid>
80105bb4:	56                   	push   %esi
80105bb5:	53                   	push   %ebx
80105bb6:	50                   	push   %eax
80105bb7:	68 84 79 10 80       	push   $0x80107984
...
80105bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bf0:	e8 0b e0 ff ff       	call   80103c00 <exit>
80105bf5:	e9 0e ff ff ff       	jmp    80105b08 <trap+0x118>
80105bfa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105c00:	e8 fb df ff ff       	call   80103c00 <exit>
80105c05:	e9 aa fe ff ff       	jmp    80105ab4 <trap+0xc4>
80105c0a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105c10:	83 ec 0c             	sub    $0xc,%esp
80105c13:	68 e0 4d 11 80       	push   $0x80114de0
80105c18:	e8 73 e9 ff ff       	call   80104590 <acquire>
      wakeup(&ticks);
80105c1d:	c7 04 24 20 56 11 80 	movl   $0x80115620,(%esp)
      ticks++;
80105c24:	83 05 20 56 11 80 01 	addl   $0x1,0x80115620
      wakeup(&ticks);
80105c2b:	e8 00 e3 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
80105c30:	c7 04 24 e0 4d 11 80 	movl   $0x80114de0,(%esp)
80105c37:	e8 14 ea ff ff       	call   80104650 <release>
80105c3c:	83 c4 10             	add    $0x10,%esp
80105c3f:	e9 09 ff ff ff       	jmp    80105b4d <trap+0x15d>
80105c44:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c47:	e8 74 db ff ff       	call   801037c0 <cpuid>
...
80105c55:	68 a8 79 10 80       	push   $0x801079a8
80105c5a:	e8 01 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c5f:	83 c4 14             	add    $0x14,%esp
80105c62:	68 7f 79 10 80       	push   $0x8010797f
...
80105cc5:	e8 a6 ca ff ff       	call   80102770 <microdelay>
...
80105d5c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d5f:	bb a0 7a 10 80       	mov    $0x80107aa0,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d64:	6a 00                	push   $0x0
80105d66:	6a 04                	push   $0x4
80105d68:	e8 63 c5 ff ff       	call   801022d0 <ioapicenable>
...
80105df7:	6a 00                	push   $0x0
  jmp alltraps
80105df9:	e9 1e fb ff ff       	jmp    8010591c <alltraps>
...
80105e00:	6a 01                	push   $0x1
  jmp alltraps
80105e02:	e9 15 fb ff ff       	jmp    8010591c <alltraps>
...
80105e09:	6a 02                	push   $0x2
  jmp alltraps
80105e0b:	e9 0c fb ff ff       	jmp    8010591c <alltraps>
...
80105e12:	6a 03                	push   $0x3
  jmp alltraps
80105e14:	e9 03 fb ff ff       	jmp    8010591c <alltraps>
...
80105e1b:	6a 04                	push   $0x4
  jmp alltraps
80105e1d:	e9 fa fa ff ff       	jmp    8010591c <alltraps>
...
80105e24:	6a 05                	push   $0x5
  jmp alltraps
80105e26:	e9 f1 fa ff ff       	jmp    8010591c <alltraps>
...
80105e2d:	6a 06                	push   $0x6
  jmp alltraps
80105e2f:	e9 e8 fa ff ff       	jmp    8010591c <alltraps>
...
80105e36:	6a 07                	push   $0x7
  jmp alltraps
80105e38:	e9 df fa ff ff       	jmp    8010591c <alltraps>
...
80105e3d:	6a 08                	push   $0x8
  jmp alltraps
80105e3f:	e9 d8 fa ff ff       	jmp    8010591c <alltraps>
...
80105e46:	6a 09                	push   $0x9
  jmp alltraps
80105e48:	e9 cf fa ff ff       	jmp    8010591c <alltraps>
...
80105e4d:	6a 0a                	push   $0xa
  jmp alltraps
80105e4f:	e9 c8 fa ff ff       	jmp    8010591c <alltraps>
...
80105e54:	6a 0b                	push   $0xb
  jmp alltraps
80105e56:	e9 c1 fa ff ff       	jmp    8010591c <alltraps>
...
80105e5b:	6a 0c                	push   $0xc
  jmp alltraps
80105e5d:	e9 ba fa ff ff       	jmp    8010591c <alltraps>
...
80105e62:	6a 0d                	push   $0xd
  jmp alltraps
80105e64:	e9 b3 fa ff ff       	jmp    8010591c <alltraps>
...
80105e69:	6a 0e                	push   $0xe
  jmp alltraps
80105e6b:	e9 ac fa ff ff       	jmp    8010591c <alltraps>
...
80105e72:	6a 0f                	push   $0xf
  jmp alltraps
80105e74:	e9 a3 fa ff ff       	jmp    8010591c <alltraps>
...
80105e7b:	6a 10                	push   $0x10
  jmp alltraps
80105e7d:	e9 9a fa ff ff       	jmp    8010591c <alltraps>
...
80105e82:	6a 11                	push   $0x11
  jmp alltraps
80105e84:	e9 93 fa ff ff       	jmp    8010591c <alltraps>
...
80105e8b:	6a 12                	push   $0x12
  jmp alltraps
80105e8d:	e9 8a fa ff ff       	jmp    8010591c <alltraps>
...
80105e94:	6a 13                	push   $0x13
  jmp alltraps
80105e96:	e9 81 fa ff ff       	jmp    8010591c <alltraps>
...
80105e9d:	6a 14                	push   $0x14
  jmp alltraps
80105e9f:	e9 78 fa ff ff       	jmp    8010591c <alltraps>
...
80105ea6:	6a 15                	push   $0x15
  jmp alltraps
80105ea8:	e9 6f fa ff ff       	jmp    8010591c <alltraps>
...
80105eaf:	6a 16                	push   $0x16
  jmp alltraps
80105eb1:	e9 66 fa ff ff       	jmp    8010591c <alltraps>
...
80105eb8:	6a 17                	push   $0x17
  jmp alltraps
80105eba:	e9 5d fa ff ff       	jmp    8010591c <alltraps>
...
80105ec1:	6a 18                	push   $0x18
  jmp alltraps
80105ec3:	e9 54 fa ff ff       	jmp    8010591c <alltraps>
...
80105eca:	6a 19                	push   $0x19
  jmp alltraps
80105ecc:	e9 4b fa ff ff       	jmp    8010591c <alltraps>
...
80105ed3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ed5:	e9 42 fa ff ff       	jmp    8010591c <alltraps>
...
80105edc:	6a 1b                	push   $0x1b
  jmp alltraps
80105ede:	e9 39 fa ff ff       	jmp    8010591c <alltraps>
...
80105ee5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ee7:	e9 30 fa ff ff       	jmp    8010591c <alltraps>
...
80105eee:	6a 1d                	push   $0x1d
  jmp alltraps
80105ef0:	e9 27 fa ff ff       	jmp    8010591c <alltraps>
...
80105ef7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ef9:	e9 1e fa ff ff       	jmp    8010591c <alltraps>
...
80105f00:	6a 1f                	push   $0x1f
  jmp alltraps
80105f02:	e9 15 fa ff ff       	jmp    8010591c <alltraps>
...
80105f09:	6a 20                	push   $0x20
  jmp alltraps
80105f0b:	e9 0c fa ff ff       	jmp    8010591c <alltraps>
...
80105f12:	6a 21                	push   $0x21
  jmp alltraps
80105f14:	e9 03 fa ff ff       	jmp    8010591c <alltraps>
...
80105f1b:	6a 22                	push   $0x22
  jmp alltraps
80105f1d:	e9 fa f9 ff ff       	jmp    8010591c <alltraps>
...
80105f24:	6a 23                	push   $0x23
  jmp alltraps
80105f26:	e9 f1 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f2d:	6a 24                	push   $0x24
  jmp alltraps
80105f2f:	e9 e8 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f36:	6a 25                	push   $0x25
  jmp alltraps
80105f38:	e9 df f9 ff ff       	jmp    8010591c <alltraps>
...
80105f3f:	6a 26                	push   $0x26
  jmp alltraps
80105f41:	e9 d6 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f48:	6a 27                	push   $0x27
  jmp alltraps
80105f4a:	e9 cd f9 ff ff       	jmp    8010591c <alltraps>
...
80105f51:	6a 28                	push   $0x28
  jmp alltraps
80105f53:	e9 c4 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f5a:	6a 29                	push   $0x29
  jmp alltraps
80105f5c:	e9 bb f9 ff ff       	jmp    8010591c <alltraps>
...
80105f63:	6a 2a                	push   $0x2a
  jmp alltraps
80105f65:	e9 b2 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f6c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f6e:	e9 a9 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f75:	6a 2c                	push   $0x2c
  jmp alltraps
80105f77:	e9 a0 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f7e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f80:	e9 97 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f87:	6a 2e                	push   $0x2e
  jmp alltraps
80105f89:	e9 8e f9 ff ff       	jmp    8010591c <alltraps>
...
80105f90:	6a 2f                	push   $0x2f
  jmp alltraps
80105f92:	e9 85 f9 ff ff       	jmp    8010591c <alltraps>
...
80105f99:	6a 30                	push   $0x30
  jmp alltraps
80105f9b:	e9 7c f9 ff ff       	jmp    8010591c <alltraps>
...
80105fa2:	6a 31                	push   $0x31
  jmp alltraps
80105fa4:	e9 73 f9 ff ff       	jmp    8010591c <alltraps>
...
80105fab:	6a 32                	push   $0x32
  jmp alltraps
80105fad:	e9 6a f9 ff ff       	jmp    8010591c <alltraps>
...
80105fb4:	6a 33                	push   $0x33
  jmp alltraps
80105fb6:	e9 61 f9 ff ff       	jmp    8010591c <alltraps>
...
80105fbd:	6a 34                	push   $0x34
  jmp alltraps
80105fbf:	e9 58 f9 ff ff       	jmp    8010591c <alltraps>
...
80105fc6:	6a 35                	push   $0x35
  jmp alltraps
80105fc8:	e9 4f f9 ff ff       	jmp    8010591c <alltraps>
...
80105fcf:	6a 36                	push   $0x36
  jmp alltraps
80105fd1:	e9 46 f9 ff ff       	jmp    8010591c <alltraps>
...
80105fd8:	6a 37                	push   $0x37
  jmp alltraps
80105fda:	e9 3d f9 ff ff       	jmp    8010591c <alltraps>
...
80105fe1:	6a 38                	push   $0x38
  jmp alltraps
80105fe3:	e9 34 f9 ff ff       	jmp    8010591c <alltraps>
...
80105fea:	6a 39                	push   $0x39
  jmp alltraps
80105fec:	e9 2b f9 ff ff       	jmp    8010591c <alltraps>
...
80105ff3:	6a 3a                	push   $0x3a
  jmp alltraps
80105ff5:	e9 22 f9 ff ff       	jmp    8010591c <alltraps>
...
80105ffc:	6a 3b                	push   $0x3b
  jmp alltraps
80105ffe:	e9 19 f9 ff ff       	jmp    8010591c <alltraps>
...
80106005:	6a 3c                	push   $0x3c
  jmp alltraps
80106007:	e9 10 f9 ff ff       	jmp    8010591c <alltraps>
...
8010600e:	6a 3d                	push   $0x3d
  jmp alltraps
80106010:	e9 07 f9 ff ff       	jmp    8010591c <alltraps>
...
80106017:	6a 3e                	push   $0x3e
  jmp alltraps
80106019:	e9 fe f8 ff ff       	jmp    8010591c <alltraps>
...
80106020:	6a 3f                	push   $0x3f
  jmp alltraps
80106022:	e9 f5 f8 ff ff       	jmp    8010591c <alltraps>
...
80106029:	6a 40                	push   $0x40
  jmp alltraps
8010602b:	e9 ec f8 ff ff       	jmp    8010591c <alltraps>
...
80106032:	6a 41                	push   $0x41
  jmp alltraps
80106034:	e9 e3 f8 ff ff       	jmp    8010591c <alltraps>
...
8010603b:	6a 42                	push   $0x42
  jmp alltraps
8010603d:	e9 da f8 ff ff       	jmp    8010591c <alltraps>
...
80106044:	6a 43                	push   $0x43
  jmp alltraps
80106046:	e9 d1 f8 ff ff       	jmp    8010591c <alltraps>
...
8010604d:	6a 44                	push   $0x44
  jmp alltraps
8010604f:	e9 c8 f8 ff ff       	jmp    8010591c <alltraps>
...
80106056:	6a 45                	push   $0x45
  jmp alltraps
80106058:	e9 bf f8 ff ff       	jmp    8010591c <alltraps>
...
8010605f:	6a 46                	push   $0x46
  jmp alltraps
80106061:	e9 b6 f8 ff ff       	jmp    8010591c <alltraps>
...
80106068:	6a 47                	push   $0x47
  jmp alltraps
8010606a:	e9 ad f8 ff ff       	jmp    8010591c <alltraps>
...
80106071:	6a 48                	push   $0x48
  jmp alltraps
80106073:	e9 a4 f8 ff ff       	jmp    8010591c <alltraps>
...
8010607a:	6a 49                	push   $0x49
  jmp alltraps
8010607c:	e9 9b f8 ff ff       	jmp    8010591c <alltraps>
...
80106083:	6a 4a                	push   $0x4a
  jmp alltraps
80106085:	e9 92 f8 ff ff       	jmp    8010591c <alltraps>
...
8010608c:	6a 4b                	push   $0x4b
  jmp alltraps
8010608e:	e9 89 f8 ff ff       	jmp    8010591c <alltraps>
...
80106095:	6a 4c                	push   $0x4c
  jmp alltraps
80106097:	e9 80 f8 ff ff       	jmp    8010591c <alltraps>
...
8010609e:	6a 4d                	push   $0x4d
  jmp alltraps
801060a0:	e9 77 f8 ff ff       	jmp    8010591c <alltraps>
...
801060a7:	6a 4e                	push   $0x4e
  jmp alltraps
801060a9:	e9 6e f8 ff ff       	jmp    8010591c <alltraps>
...
801060b0:	6a 4f                	push   $0x4f
  jmp alltraps
801060b2:	e9 65 f8 ff ff       	jmp    8010591c <alltraps>
...
801060b9:	6a 50                	push   $0x50
  jmp alltraps
801060bb:	e9 5c f8 ff ff       	jmp    8010591c <alltraps>
...
801060c2:	6a 51                	push   $0x51
  jmp alltraps
801060c4:	e9 53 f8 ff ff       	jmp    8010591c <alltraps>
...
801060cb:	6a 52                	push   $0x52
  jmp alltraps
801060cd:	e9 4a f8 ff ff       	jmp    8010591c <alltraps>
...
801060d4:	6a 53                	push   $0x53
  jmp alltraps
801060d6:	e9 41 f8 ff ff       	jmp    8010591c <alltraps>
...
801060dd:	6a 54                	push   $0x54
  jmp alltraps
801060df:	e9 38 f8 ff ff       	jmp    8010591c <alltraps>
...
801060e6:	6a 55                	push   $0x55
  jmp alltraps
801060e8:	e9 2f f8 ff ff       	jmp    8010591c <alltraps>
...
801060ef:	6a 56                	push   $0x56
  jmp alltraps
801060f1:	e9 26 f8 ff ff       	jmp    8010591c <alltraps>
...
801060f8:	6a 57                	push   $0x57
  jmp alltraps
801060fa:	e9 1d f8 ff ff       	jmp    8010591c <alltraps>
...
80106101:	6a 58                	push   $0x58
  jmp alltraps
80106103:	e9 14 f8 ff ff       	jmp    8010591c <alltraps>
...
8010610a:	6a 59                	push   $0x59
  jmp alltraps
8010610c:	e9 0b f8 ff ff       	jmp    8010591c <alltraps>
...
80106113:	6a 5a                	push   $0x5a
  jmp alltraps
80106115:	e9 02 f8 ff ff       	jmp    8010591c <alltraps>
...
8010611c:	6a 5b                	push   $0x5b
  jmp alltraps
8010611e:	e9 f9 f7 ff ff       	jmp    8010591c <alltraps>
...
80106125:	6a 5c                	push   $0x5c
  jmp alltraps
80106127:	e9 f0 f7 ff ff       	jmp    8010591c <alltraps>
...
8010612e:	6a 5d                	push   $0x5d
  jmp alltraps
80106130:	e9 e7 f7 ff ff       	jmp    8010591c <alltraps>
...
80106137:	6a 5e                	push   $0x5e
  jmp alltraps
80106139:	e9 de f7 ff ff       	jmp    8010591c <alltraps>
...
80106140:	6a 5f                	push   $0x5f
  jmp alltraps
80106142:	e9 d5 f7 ff ff       	jmp    8010591c <alltraps>
...
80106149:	6a 60                	push   $0x60
  jmp alltraps
8010614b:	e9 cc f7 ff ff       	jmp    8010591c <alltraps>
...
80106152:	6a 61                	push   $0x61
  jmp alltraps
80106154:	e9 c3 f7 ff ff       	jmp    8010591c <alltraps>
...
8010615b:	6a 62                	push   $0x62
  jmp alltraps
8010615d:	e9 ba f7 ff ff       	jmp    8010591c <alltraps>
...
80106164:	6a 63                	push   $0x63
  jmp alltraps
80106166:	e9 b1 f7 ff ff       	jmp    8010591c <alltraps>
...
8010616d:	6a 64                	push   $0x64
  jmp alltraps
8010616f:	e9 a8 f7 ff ff       	jmp    8010591c <alltraps>
...
80106176:	6a 65                	push   $0x65
  jmp alltraps
80106178:	e9 9f f7 ff ff       	jmp    8010591c <alltraps>
...
8010617f:	6a 66                	push   $0x66
  jmp alltraps
80106181:	e9 96 f7 ff ff       	jmp    8010591c <alltraps>
...
80106188:	6a 67                	push   $0x67
  jmp alltraps
8010618a:	e9 8d f7 ff ff       	jmp    8010591c <alltraps>
...
80106191:	6a 68                	push   $0x68
  jmp alltraps
80106193:	e9 84 f7 ff ff       	jmp    8010591c <alltraps>
...
8010619a:	6a 69                	push   $0x69
  jmp alltraps
8010619c:	e9 7b f7 ff ff       	jmp    8010591c <alltraps>
...
801061a3:	6a 6a                	push   $0x6a
  jmp alltraps
801061a5:	e9 72 f7 ff ff       	jmp    8010591c <alltraps>
...
801061ac:	6a 6b                	push   $0x6b
  jmp alltraps
801061ae:	e9 69 f7 ff ff       	jmp    8010591c <alltraps>
...
801061b5:	6a 6c                	push   $0x6c
  jmp alltraps
801061b7:	e9 60 f7 ff ff       	jmp    8010591c <alltraps>
...
801061be:	6a 6d                	push   $0x6d
  jmp alltraps
801061c0:	e9 57 f7 ff ff       	jmp    8010591c <alltraps>
...
801061c7:	6a 6e                	push   $0x6e
  jmp alltraps
801061c9:	e9 4e f7 ff ff       	jmp    8010591c <alltraps>
...
801061d0:	6a 6f                	push   $0x6f
  jmp alltraps
801061d2:	e9 45 f7 ff ff       	jmp    8010591c <alltraps>
...
801061d9:	6a 70                	push   $0x70
  jmp alltraps
801061db:	e9 3c f7 ff ff       	jmp    8010591c <alltraps>
...
801061e2:	6a 71                	push   $0x71
  jmp alltraps
801061e4:	e9 33 f7 ff ff       	jmp    8010591c <alltraps>
...
801061eb:	6a 72                	push   $0x72
  jmp alltraps
801061ed:	e9 2a f7 ff ff       	jmp    8010591c <alltraps>
...
801061f4:	6a 73                	push   $0x73
  jmp alltraps
801061f6:	e9 21 f7 ff ff       	jmp    8010591c <alltraps>
...
801061fd:	6a 74                	push   $0x74
  jmp alltraps
801061ff:	e9 18 f7 ff ff       	jmp    8010591c <alltraps>
...
80106206:	6a 75                	push   $0x75
  jmp alltraps
80106208:	e9 0f f7 ff ff       	jmp    8010591c <alltraps>
...
8010620f:	6a 76                	push   $0x76
  jmp alltraps
80106211:	e9 06 f7 ff ff       	jmp    8010591c <alltraps>
...
80106218:	6a 77                	push   $0x77
  jmp alltraps
8010621a:	e9 fd f6 ff ff       	jmp    8010591c <alltraps>
...
80106221:	6a 78                	push   $0x78
  jmp alltraps
80106223:	e9 f4 f6 ff ff       	jmp    8010591c <alltraps>
...
8010622a:	6a 79                	push   $0x79
  jmp alltraps
8010622c:	e9 eb f6 ff ff       	jmp    8010591c <alltraps>
...
80106233:	6a 7a                	push   $0x7a
  jmp alltraps
80106235:	e9 e2 f6 ff ff       	jmp    8010591c <alltraps>
...
8010623c:	6a 7b                	push   $0x7b
  jmp alltraps
8010623e:	e9 d9 f6 ff ff       	jmp    8010591c <alltraps>
...
80106245:	6a 7c                	push   $0x7c
  jmp alltraps
80106247:	e9 d0 f6 ff ff       	jmp    8010591c <alltraps>
...
8010624e:	6a 7d                	push   $0x7d
  jmp alltraps
80106250:	e9 c7 f6 ff ff       	jmp    8010591c <alltraps>
...
80106257:	6a 7e                	push   $0x7e
  jmp alltraps
80106259:	e9 be f6 ff ff       	jmp    8010591c <alltraps>
...
80106260:	6a 7f                	push   $0x7f
  jmp alltraps
80106262:	e9 b5 f6 ff ff       	jmp    8010591c <alltraps>
...
80106269:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010626e:	e9 a9 f6 ff ff       	jmp    8010591c <alltraps>
...
80106275:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010627a:	e9 9d f6 ff ff       	jmp    8010591c <alltraps>
...
80106281:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106286:	e9 91 f6 ff ff       	jmp    8010591c <alltraps>
...
8010628d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106292:	e9 85 f6 ff ff       	jmp    8010591c <alltraps>
...
80106299:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010629e:	e9 79 f6 ff ff       	jmp    8010591c <alltraps>
...
801062a5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801062aa:	e9 6d f6 ff ff       	jmp    8010591c <alltraps>
...
801062b1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801062b6:	e9 61 f6 ff ff       	jmp    8010591c <alltraps>
...
801062bd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801062c2:	e9 55 f6 ff ff       	jmp    8010591c <alltraps>
...
801062c9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801062ce:	e9 49 f6 ff ff       	jmp    8010591c <alltraps>
...
801062d5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062da:	e9 3d f6 ff ff       	jmp    8010591c <alltraps>
...
801062e1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062e6:	e9 31 f6 ff ff       	jmp    8010591c <alltraps>
...
801062ed:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062f2:	e9 25 f6 ff ff       	jmp    8010591c <alltraps>
...
801062f9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062fe:	e9 19 f6 ff ff       	jmp    8010591c <alltraps>
...
80106305:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010630a:	e9 0d f6 ff ff       	jmp    8010591c <alltraps>
...
80106311:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106316:	e9 01 f6 ff ff       	jmp    8010591c <alltraps>
...
8010631d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106322:	e9 f5 f5 ff ff       	jmp    8010591c <alltraps>
...
80106329:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010632e:	e9 e9 f5 ff ff       	jmp    8010591c <alltraps>
...
80106335:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010633a:	e9 dd f5 ff ff       	jmp    8010591c <alltraps>
...
80106341:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106346:	e9 d1 f5 ff ff       	jmp    8010591c <alltraps>
...
8010634d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106352:	e9 c5 f5 ff ff       	jmp    8010591c <alltraps>
...
80106359:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010635e:	e9 b9 f5 ff ff       	jmp    8010591c <alltraps>
...
80106365:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010636a:	e9 ad f5 ff ff       	jmp    8010591c <alltraps>
...
80106371:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106376:	e9 a1 f5 ff ff       	jmp    8010591c <alltraps>
...
8010637d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106382:	e9 95 f5 ff ff       	jmp    8010591c <alltraps>
...
80106389:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010638e:	e9 89 f5 ff ff       	jmp    8010591c <alltraps>
...
80106395:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010639a:	e9 7d f5 ff ff       	jmp    8010591c <alltraps>
...
801063a1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801063a6:	e9 71 f5 ff ff       	jmp    8010591c <alltraps>
...
801063ad:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801063b2:	e9 65 f5 ff ff       	jmp    8010591c <alltraps>
...
801063b9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801063be:	e9 59 f5 ff ff       	jmp    8010591c <alltraps>
...
801063c5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801063ca:	e9 4d f5 ff ff       	jmp    8010591c <alltraps>
...
801063d1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063d6:	e9 41 f5 ff ff       	jmp    8010591c <alltraps>
...
801063dd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063e2:	e9 35 f5 ff ff       	jmp    8010591c <alltraps>
...
801063e9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063ee:	e9 29 f5 ff ff       	jmp    8010591c <alltraps>
...
801063f5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063fa:	e9 1d f5 ff ff       	jmp    8010591c <alltraps>
...
80106401:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106406:	e9 11 f5 ff ff       	jmp    8010591c <alltraps>
...
8010640d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106412:	e9 05 f5 ff ff       	jmp    8010591c <alltraps>
...
80106419:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010641e:	e9 f9 f4 ff ff       	jmp    8010591c <alltraps>
...
80106425:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010642a:	e9 ed f4 ff ff       	jmp    8010591c <alltraps>
...
80106431:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106436:	e9 e1 f4 ff ff       	jmp    8010591c <alltraps>
...
8010643d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106442:	e9 d5 f4 ff ff       	jmp    8010591c <alltraps>
...
80106449:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010644e:	e9 c9 f4 ff ff       	jmp    8010591c <alltraps>
...
80106455:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010645a:	e9 bd f4 ff ff       	jmp    8010591c <alltraps>
...
80106461:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106466:	e9 b1 f4 ff ff       	jmp    8010591c <alltraps>
...
8010646d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106472:	e9 a5 f4 ff ff       	jmp    8010591c <alltraps>
...
80106479:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010647e:	e9 99 f4 ff ff       	jmp    8010591c <alltraps>
...
80106485:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010648a:	e9 8d f4 ff ff       	jmp    8010591c <alltraps>
...
80106491:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106496:	e9 81 f4 ff ff       	jmp    8010591c <alltraps>
...
8010649d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801064a2:	e9 75 f4 ff ff       	jmp    8010591c <alltraps>
...
801064a9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801064ae:	e9 69 f4 ff ff       	jmp    8010591c <alltraps>
...
801064b5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801064ba:	e9 5d f4 ff ff       	jmp    8010591c <alltraps>
...
801064c1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801064c6:	e9 51 f4 ff ff       	jmp    8010591c <alltraps>
...
801064cd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064d2:	e9 45 f4 ff ff       	jmp    8010591c <alltraps>
...
801064d9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064de:	e9 39 f4 ff ff       	jmp    8010591c <alltraps>
...
801064e5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064ea:	e9 2d f4 ff ff       	jmp    8010591c <alltraps>
...
801064f1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064f6:	e9 21 f4 ff ff       	jmp    8010591c <alltraps>
...
801064fd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106502:	e9 15 f4 ff ff       	jmp    8010591c <alltraps>
...
80106509:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010650e:	e9 09 f4 ff ff       	jmp    8010591c <alltraps>
...
80106515:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010651a:	e9 fd f3 ff ff       	jmp    8010591c <alltraps>
...
80106521:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106526:	e9 f1 f3 ff ff       	jmp    8010591c <alltraps>
...
8010652d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106532:	e9 e5 f3 ff ff       	jmp    8010591c <alltraps>
...
80106539:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010653e:	e9 d9 f3 ff ff       	jmp    8010591c <alltraps>
...
80106545:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010654a:	e9 cd f3 ff ff       	jmp    8010591c <alltraps>
...
80106551:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106556:	e9 c1 f3 ff ff       	jmp    8010591c <alltraps>
...
8010655d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106562:	e9 b5 f3 ff ff       	jmp    8010591c <alltraps>
...
80106569:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010656e:	e9 a9 f3 ff ff       	jmp    8010591c <alltraps>
...
80106575:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010657a:	e9 9d f3 ff ff       	jmp    8010591c <alltraps>
...
80106581:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106586:	e9 91 f3 ff ff       	jmp    8010591c <alltraps>
...
8010658d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106592:	e9 85 f3 ff ff       	jmp    8010591c <alltraps>
...
80106599:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010659e:	e9 79 f3 ff ff       	jmp    8010591c <alltraps>
...
801065a5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801065aa:	e9 6d f3 ff ff       	jmp    8010591c <alltraps>
...
801065b1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801065b6:	e9 61 f3 ff ff       	jmp    8010591c <alltraps>
...
801065bd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801065c2:	e9 55 f3 ff ff       	jmp    8010591c <alltraps>
...
801065c9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801065ce:	e9 49 f3 ff ff       	jmp    8010591c <alltraps>
...
801065d5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065da:	e9 3d f3 ff ff       	jmp    8010591c <alltraps>
...
801065e1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065e6:	e9 31 f3 ff ff       	jmp    8010591c <alltraps>
...
801065ed:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065f2:	e9 25 f3 ff ff       	jmp    8010591c <alltraps>
...
801065f9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065fe:	e9 19 f3 ff ff       	jmp    8010591c <alltraps>
...
80106605:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010660a:	e9 0d f3 ff ff       	jmp    8010591c <alltraps>
...
80106611:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106616:	e9 01 f3 ff ff       	jmp    8010591c <alltraps>
...
8010661d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106622:	e9 f5 f2 ff ff       	jmp    8010591c <alltraps>
...
80106629:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010662e:	e9 e9 f2 ff ff       	jmp    8010591c <alltraps>
...
80106635:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010663a:	e9 dd f2 ff ff       	jmp    8010591c <alltraps>
...
80106641:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106646:	e9 d1 f2 ff ff       	jmp    8010591c <alltraps>
...
8010664d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106652:	e9 c5 f2 ff ff       	jmp    8010591c <alltraps>
...
80106659:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010665e:	e9 b9 f2 ff ff       	jmp    8010591c <alltraps>
...
80106665:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010666a:	e9 ad f2 ff ff       	jmp    8010591c <alltraps>
...
80106671:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106676:	e9 a1 f2 ff ff       	jmp    8010591c <alltraps>
...
8010667d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106682:	e9 95 f2 ff ff       	jmp    8010591c <alltraps>
...
80106689:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010668e:	e9 89 f2 ff ff       	jmp    8010591c <alltraps>
...
80106695:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010669a:	e9 7d f2 ff ff       	jmp    8010591c <alltraps>
...
801066a1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801066a6:	e9 71 f2 ff ff       	jmp    8010591c <alltraps>
...
801066ad:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801066b2:	e9 65 f2 ff ff       	jmp    8010591c <alltraps>
...
801066b9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801066be:	e9 59 f2 ff ff       	jmp    8010591c <alltraps>
...
801066c5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801066ca:	e9 4d f2 ff ff       	jmp    8010591c <alltraps>
...
801066d1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066d6:	e9 41 f2 ff ff       	jmp    8010591c <alltraps>
...
801066dd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066e2:	e9 35 f2 ff ff       	jmp    8010591c <alltraps>
...
801066e9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066ee:	e9 29 f2 ff ff       	jmp    8010591c <alltraps>
...
801066f5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066fa:	e9 1d f2 ff ff       	jmp    8010591c <alltraps>
...
80106701:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106706:	e9 11 f2 ff ff       	jmp    8010591c <alltraps>
...
8010670d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106712:	e9 05 f2 ff ff       	jmp    8010591c <alltraps>
...
80106719:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010671e:	e9 f9 f1 ff ff       	jmp    8010591c <alltraps>
...
80106725:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010672a:	e9 ed f1 ff ff       	jmp    8010591c <alltraps>
...
80106731:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106736:	e9 e1 f1 ff ff       	jmp    8010591c <alltraps>
...
8010673d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106742:	e9 d5 f1 ff ff       	jmp    8010591c <alltraps>
...
80106749:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010674e:	e9 c9 f1 ff ff       	jmp    8010591c <alltraps>
...
80106755:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010675a:	e9 bd f1 ff ff       	jmp    8010591c <alltraps>
...
80106761:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106766:	e9 b1 f1 ff ff       	jmp    8010591c <alltraps>
...
8010676d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106772:	e9 a5 f1 ff ff       	jmp    8010591c <alltraps>
...
80106779:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010677e:	e9 99 f1 ff ff       	jmp    8010591c <alltraps>
...
80106785:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010678a:	e9 8d f1 ff ff       	jmp    8010591c <alltraps>
...
80106791:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106796:	e9 81 f1 ff ff       	jmp    8010591c <alltraps>
...
8010679d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801067a2:	e9 75 f1 ff ff       	jmp    8010591c <alltraps>
...
801067a9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801067ae:	e9 69 f1 ff ff       	jmp    8010591c <alltraps>
...
801067b5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801067ba:	e9 5d f1 ff ff       	jmp    8010591c <alltraps>
...
801067c1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801067c6:	e9 51 f1 ff ff       	jmp    8010591c <alltraps>
...
801067cd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067d2:	e9 45 f1 ff ff       	jmp    8010591c <alltraps>
...
801067d9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067de:	e9 39 f1 ff ff       	jmp    8010591c <alltraps>
...
801067e5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067ea:	e9 2d f1 ff ff       	jmp    8010591c <alltraps>
...
801067f1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067f6:	e9 21 f1 ff ff       	jmp    8010591c <alltraps>
...
801067fd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106802:	e9 15 f1 ff ff       	jmp    8010591c <alltraps>
...
80106809:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010680e:	e9 09 f1 ff ff       	jmp    8010591c <alltraps>
...
80106815:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010681a:	e9 fd f0 ff ff       	jmp    8010591c <alltraps>
...
80106821:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106826:	e9 f1 f0 ff ff       	jmp    8010591c <alltraps>
...
8010682d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106832:	e9 e5 f0 ff ff       	jmp    8010591c <alltraps>
...
80106839:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010683e:	e9 d9 f0 ff ff       	jmp    8010591c <alltraps>
...
80106845:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010684a:	e9 cd f0 ff ff       	jmp    8010591c <alltraps>
...
80106851:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106856:	e9 c1 f0 ff ff       	jmp    8010591c <alltraps>
...
8010685d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106862:	e9 b5 f0 ff ff       	jmp    8010591c <alltraps>
...
801068b4:	e8 07 bc ff ff       	call   801024c0 <kalloc>
...
801068ca:	e8 d1 dd ff ff       	call   801046a0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010696d:	68 a8 7a 10 80       	push   $0x80107aa8
...
801069c4:	e8 47 b9 ff ff       	call   80102310 <kfree>
      *pte = 0;
...
80106a23:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a26:	e8 95 cd ff ff       	call   801037c0 <cpuid>
...
80106ab0:	a1 24 56 11 80       	mov    0x80115624,%eax
{
...
80106aff:	e8 3c cc ff ff       	call   80103740 <mycpu>
80106b04:	89 c6                	mov    %eax,%esi
80106b06:	e8 35 cc ff ff       	call   80103740 <mycpu>
...
80106b18:	e8 23 cc ff ff       	call   80103740 <mycpu>
...
80106b61:	e8 da cb ff ff       	call   80103740 <mycpu>
...
80106b79:	e8 c2 cb ff ff       	call   80103740 <mycpu>
80106b7e:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106b84:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b87:	e8 b4 cb ff ff       	call   80103740 <mycpu>
...
80106bfb:	77 49                	ja     80106c46 <inituvm+0x66>
  mem = kalloc();
80106bfd:	e8 be b8 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106c40:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c41:	e9 0a db ff ff       	jmp    80104750 <memmove>
    panic("inituvm: more than a page");
80106c46:	83 ec 0c             	sub    $0xc,%esp
80106c49:	68 ed 7a 10 80       	push   $0x80107aed
...
80106cd1:	e8 8a ac ff ff       	call   80101960 <readi>
...
80106d6b:	e8 30 d9 ff ff       	call   801046a0 <memset>
...
80106d99:	0f 86 81 00 00 00    	jbe    80106e20 <allocuvm+0x100>
    mem = kalloc();
80106d9f:	e8 1c b7 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106dad:	68 25 7b 10 80       	push   $0x80107b25
...
80106de3:	68 3d 7b 10 80       	push   $0x80107b3d
...
80106e0b:	e8 00 b5 ff ff       	call   80102310 <kfree>
      return 0;
...
80106ece:	e8 3d b4 ff ff       	call   80102310 <kfree>
...
80106ee3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106ee4:	e9 27 b4 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106ee9:	83 ec 0c             	sub    $0xc,%esp
80106eec:	68 59 7b 10 80       	push   $0x80107b59
...
80106f05:	e8 b6 b5 ff ff       	call   801024c0 <kalloc>
...
80106f8b:	a3 24 56 11 80       	mov    %eax,0x80115624
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106fbf:	68 6a 7b 10 80       	push   $0x80107b6a
...
80107010:	e8 3b d7 ff ff       	call   80104750 <memmove>
...
80107065:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107068:	e8 53 b4 ff ff       	call   801024c0 <kalloc>
...
8010713f:	e8 0c d6 ff ff       	call   80104750 <memmove>
    len -= n;
    buf += n;
