...
int main(int argc, char *argv[]){   
  ...
  53:	53                   	push   %ebx
  54:	e8 d9 03 00 00       	call   432 <sem_acquire>
            sem_acquire((id+1)%5);
  59:	89 34 24             	mov    %esi,(%esp)
  5c:	e8 d1 03 00 00       	call   432 <sem_acquire>
  ...
  6c:	e8 a1 03 00 00       	call   412 <sleep>
        sem_acquire(5);
  71:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  78:	e8 b5 03 00 00       	call   432 <sem_acquire>
  ...
  97:	6a 01                	push   $0x1
  99:	e8 52 04 00 00       	call   4f0 <printf>
        sem_release(5);
  9e:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  a5:	e8 90 03 00 00       	call   43a <sem_release>

        sem_release(id);
  aa:	89 1c 24             	mov    %ebx,(%esp)
  ad:	e8 88 03 00 00       	call   43a <sem_release>
        sem_release(((id+1)%5));
  b2:	89 34 24             	mov    %esi,(%esp)
  b5:	e8 80 03 00 00       	call   43a <sem_release>

        sleep(1000);
  ba:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
  c1:	e8 4c 03 00 00       	call   412 <sleep>
        sem_acquire(5);
  c6:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  cd:	e8 60 03 00 00       	call   432 <sem_acquire>
 ...
 10d:	56                   	push   %esi
 10e:	e8 1f 03 00 00       	call   432 <sem_acquire>
            sem_acquire(id);
 113:	89 1c 24             	mov    %ebx,(%esp)
 116:	e8 17 03 00 00       	call   432 <sem_acquire>
...
00000422 <find_largest_prime_factor>:
 ...
 459:	85 d2                	test   %edx,%edx
{
 ...
 487:	f7 f1                	div    %ecx
 489:	0f b6 92 e8 08 00 00 	movzbl 0x8e8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6a4:	e9 8f fe ff ff       	jmp    538 <printf+0x48>
          s = "(null)";
 6a9:	bb de 08 00 00       	mov    $0x8de,%ebx
        while(*s != 0){
 ...
 6c1:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 6fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ff:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 704:	5b                   	pop    %ebx
 705:	5e                   	pop    %esi
 706:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 15 98 0b 00 00    	mov    0xb98,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 47                	jae    7e8 <malloc+0x98>
    ...
    if(p == freep)
 7a1:	39 05 98 0b 00 00    	cmp    %eax,0xb98
 ...
 7c6:	e8 f5 fe ff ff       	call   6c0 <free>
  return freep;
 7cb:	8b 15 98 0b 00 00    	mov    0xb98,%edx
 ...
 7f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7f7:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 817:	0b 00 00 
 81a:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 821:	0b 00 00 
    base.s.size = 0;
 824:	b8 9c 0b 00 00       	mov    $0xb9c,%eax
