...
int main(int argc, char *argv[]) {
  ...
  29:	e8 6c 03 00 00       	call   39a <sem_init>
  ...
  36:	8d 7d db             	lea    -0x25(%ebp),%edi
            exec("philsof", map_handler);
  39:	8d 75 dc             	lea    -0x24(%ebp),%esi
    for (int i = 0 ; i < 5 ; i++){
  3c:	31 db                	xor    %ebx,%ebx
        int pid = fork();
  3e:	e8 a7 02 00 00       	call   2ea <fork>
        if (pid == 0){
  43:	85 c0                	test   %eax,%eax
  45:	74 29                	je     70 <main+0x70>
    for (int i = 0 ; i < 5 ; i++){
  47:	83 c3 01             	add    $0x1,%ebx
  4a:	83 fb 05             	cmp    $0x5,%ebx
  4d:	75 ef                	jne    3e <main+0x3e>
        }
    }
    for (int i = 0 ; i < 5 ; i++) wait();
  4f:	e8 a6 02 00 00       	call   2fa <wait>
  54:	e8 a1 02 00 00       	call   2fa <wait>
  59:	e8 9c 02 00 00       	call   2fa <wait>
  5e:	e8 97 02 00 00       	call   2fa <wait>
  63:	e8 92 02 00 00       	call   2fa <wait>
    exit();
  68:	e8 85 02 00 00       	call   2f2 <exit>
  6d:	8d 76 00             	lea    0x0(%esi),%esi
            exec("philsof", map_handler);
  70:	83 ec 08             	sub    $0x8,%esp
            arg[0] = num;
  73:	8d 43 30             	lea    0x30(%ebx),%eax
            char *map_handler[] = {(char *) "philsof", arg, 0};
  76:	c7 45 dc b8 07 00 00 	movl   $0x7b8,-0x24(%ebp)
            exec("philsof", map_handler);
  7d:	56                   	push   %esi
  7e:	68 b8 07 00 00       	push   $0x7b8
            arg[0] = num;
  83:	88 45 db             	mov    %al,-0x25(%ebp)
            char *map_handler[] = {(char *) "philsof", arg, 0};
  86:	89 7d e0             	mov    %edi,-0x20(%ebp)
  89:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
            exec("philsof", map_handler);
  90:	e8 95 02 00 00       	call   32a <exec>
  95:	83 c4 10             	add    $0x10,%esp
  98:	eb ad                	jmp    47 <main+0x47>
  9a:	66 90                	xchg   %ax,%ax
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
...
00000392 <find_largest_prime_factor>:
...
000003a2 <sem_acquire>:
SYSCALL(sem_acquire)
 3a2:	b8 18 00 00 00       	mov    $0x18,%eax
 3a7:	cd 40                	int    $0x40
 3a9:	c3                   	ret    

000003aa <sem_release>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	e9 8f fe ff ff       	jmp    4a8 <printf+0x48>
          s = "(null)";
 619:	bb c0 07 00 00       	mov    $0x7c0,%ebx
        while(*s != 0){
 ...
 631:	a1 78 0a 00 00       	mov    0xa78,%eax
{
 ...
 66d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 66f:	a3 78 0a 00 00       	mov    %eax,0xa78
}
 674:	5b                   	pop    %ebx
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 78 0a 00 00    	mov    0xa78,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 787:	0a 00 00 
 78a:	c7 05 7c 0a 00 00 7c 	movl   $0xa7c,0xa7c
 791:	0a 00 00 
    base.s.size = 0;
 794:	b8 7c 0a 00 00       	mov    $0xa7c,%eax
 799:	c7 05 80 0a 00 00 00 	movl   $0x0,0xa80
 7a0:	00 00 00 
