...
_getlargestprime:     file format elf32-i386
...
int main (int argc, char *argv[]) {
  ...
  39:	e8 14 03 00 00       	call   352 <find_largest_prime_factor>
...
00000352 <find_largest_prime_factor>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb b0 07 00 00       	mov    $0x7b0,%ebx
        while(*s != 0){
